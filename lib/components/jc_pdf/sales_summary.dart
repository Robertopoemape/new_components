...
pw.Widget _buildTotalsTable(
  ...
  return pw.Table(
    ...
    columnWidths: {
      0: const pw.FlexColumnWidth(0.265),
...
pw.Widget _buildHeader(
  ...
  return pw.Column(
    ...
    children: [
      ...
      _buildInfoRow('Cajero: ', cashierEmail, ttf),
      _buildInfoRow('Datos del cajero: ', cashierNames, ttf),
