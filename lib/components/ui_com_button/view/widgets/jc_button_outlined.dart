...
class JcButtonOutlined extends StatefulWidget {
  const JcButtonOutlined({
  ...
  @override
  State<JcButtonOutlined> createState() => _JcButtonOutlinedState();
}

class _JcButtonOutlinedState extends State<JcButtonOutlined> {
          ...
          children: <Widget>[
            if (currentButtonState == ButtonState.loading)
              ...
              if (widget.onPressed != null) ...[
                Text(
                  widget.nameButton,
                  style: JcTextStyle.button1.w600.copyWith(
                    color: widget.onPressed == null
                        ? widget.theme == ThemeButton.light
                            ? JcColors.gs600
                            : JcColors.gs800
