...
class JcButtonPrimary extends StatefulWidget {
  const JcButtonPrimary({
  ...
  @override
  State<JcButtonPrimary> createState() => _JcButtonPrimaryState();
}

class _JcButtonPrimaryState extends State<JcButtonPrimary> {
