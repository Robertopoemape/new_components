...
class JcButtonTextSecondary extends StatefulWidget {
  const JcButtonTextSecondary({
  ...
  @override
  State<JcButtonTextSecondary> createState() => _JcButtonTextSecondaryState();
}

class _JcButtonTextSecondaryState extends State<JcButtonTextSecondary> {
