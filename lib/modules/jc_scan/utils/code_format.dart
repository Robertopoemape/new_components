// ignore_for_file: constant_identifier_names, avoid_catches_without_on_clauses, unnecessary_final
...
extension CodeFormatUtils on CodeFormat {
  ...
  static const List<CodeFormat> ALL_1D_FORMATS = <CodeFormat>[
    CodeFormat.CODABAR,
    CodeFormat.CODE_39,
    CodeFormat.CODE_93,
    CodeFormat.CODE_128,
  ...
  static const List<CodeFormat> ALL_1D_PRODUCT_FORMATS = <CodeFormat>[
    CodeFormat.EAN_8,
    CodeFormat.EAN_13,
    CodeFormat.UPC_A,
    CodeFormat.UPC_E,
  ...
  static const List<CodeFormat> ALL_1D_INDUSTRIAL_FORMATS = <CodeFormat>[
    CodeFormat.CODABAR,
    CodeFormat.CODE_39,
    CodeFormat.CODE_93,
    CodeFormat.CODE_128,
  ...
  static const List<CodeFormat> ALL_2D_FORMATS = <CodeFormat>[
    CodeFormat.AZTEC,
  ...
  static Map<String, dynamic> getAsProperties(
    ...
    if (codeFormats.isEmpty) {
      return <String, dynamic>{};
    }

    final mapProperties = <String, dynamic>{};
    for (final codeFormat in codeFormats) {
  ...
  static Map<String, dynamic> getAsPropertiesComplement(
    ...
    final mapProperties = getAsProperties(codeFormats, enabled: enabled);
    for (final codeFormat in CodeFormat.values) {
      final propertyName = codeFormat.propertyName;
